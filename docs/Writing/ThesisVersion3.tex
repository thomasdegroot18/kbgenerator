...
\begin{document}
	...
	\begin{titlepage}
		...
		\begin{figure}[h]
			\centering
			\subfloat{%
				\includegraphics[width=2.5cm]{images/vu-logo.png}
			}
			\subfloat{%
				\includegraphics[width=2.5cm]{images/uva-logo.png}
			}
		\end{figure}
		\textsc{\large \red{VU \& UvA}}\\[1.0cm] % 
	...
	\begin{figure}[!t]
		\subfloat[Example contradiction 1.\label{fig:Example1}]{%
			\includegraphics[width=0.46\textwidth]{images/Example1.png}
		}
	...
	\begin{figure}[!t]
		\subfloat[A diagram that shows the retrieval and splitting of subgraphs from the knowledge graph.\label{fig:subgraphRetrieval}]{
			\includegraphics[width=0.5\textwidth]{images/SubgraphRetrieval.png}
		}
		\subfloat[A diagram that shows the retrieval of justifications from a single subgraph.\label{fig:JustificationRetrieval}]{
			\includegraphics[width=0.5\textwidth]{images/JustificationRetrieval.png}
		}
	\end{figure}
	...
	\begin{figure}[!t]
		\subfloat[A schematic diagram showcasing how the justifications are transformed into `anti-patterns'.\label{fig:PatternGeneralizing}]{%
			\includegraphics[width=0.5\textwidth]{images/PatternGeneralizing.png}
		}
		\subfloat[A diagram that shows the transformation from justification to a `anti-pattern'\label{fig:JustificationtoGeneral}]{%
			\includegraphics[width=0.5\textwidth]{images/JustificationtoGeneral.png}
		}
	\end{figure}
	...
	\end{itemize} 
	\begin{figure}[!t]
		\subfloat[This diagram shows one of the use-cases for the `anti-patterns', namely Analytics.\label{fig:AnalyticsDrawing}]{%
	...
	\begin{algorithm}
		...
		\ForEach{triple \textbf{in} KnowledgeGraph }{
			\eIf{triple does not belong to protected inconsistency}{
	...
	\begin{figure}[!t]
		\subfloat[The distribution of indegree over all nodes.\label{fig:indegree}]{%
			\includegraphics[width=0.5\textwidth]{images/figure4.eps}
		}
	...
	\begin{figure}[!t]
		\subfloat[Plot showing the Distribution of size.\label{fig:DistributionSize}]{%
			\includegraphics[width=0.5\textwidth]{images/figure1.eps}
		}
		\subfloat[The distribution of the Clustering Coefficient over all nodes.\label{fig:Coeff2}]{%
			\includegraphics[width=0.5\textwidth]{images/figure6.eps}
			\label{fig:AntipatternStats_2}
		}
	\end{figure}
	...
	\begin{figure}[!t]
		...
		\subfloat[Plot showing the Distribution of Distinct `anti-patterns'.\label{fig:SizeDistinct}]{%
			\includegraphics[width=0.5\textwidth]{images/figure2.eps}
		}
		\subfloat[Plot showing the Distribution of occurrences.\label{fig:Distributionoccurrences}]{%
			\includegraphics[width=0.5\textwidth]{images/figure3.eps}
		}
	...
	\begin{figure}[t]
		\subfloat[The distribution of indegree over all nodes of the sample.\label{fig:indegreeSample}]{%
			\includegraphics[width=0.5\textwidth]{images/Samplefigure4.eps}
		}
		\subfloat[The distribution of outdegree over all nodes of the sample.\label{fig:outdegreeSample}]{%
			\includegraphics[width=0.5\textwidth]{images/Samplefigure5.eps}
			\label{fig:AntipatternStats_4}
		}
	...
	\begin{figure}[ht]
		\subfloat[Plot showing the Distribution of `anti-pattern' size, for the sampled and original graph.\label{fig:DistributionSizeSample}]{%
			\includegraphics[width=0.5\textwidth]{images/Samplefigure1.eps}
		}
		\subfloat[The distribution of the Clustering Coefficient over all nodes of the sample.\label{fig:CoeffSample}]{%
			\includegraphics[width=0.5\textwidth]{images/Samplefigure6.eps}
			\label{fig:AntipatternStats_5}
		}
	\end{figure}
	\begin{figure}[!b]
		\centering
		...
		\subfloat[Shows the distribution of distinct `anti-patterns', for the sampled and original graphs.\label{fig:SizeDistinctSample}]{%
			\includegraphics[width=0.5\textwidth]{images/Samplefigure2.eps}
		}
		\subfloat[Shows the distribution of occurrences, for the sampled and original graphs.\label{fig:DistributionoccurrencesSample}]{%
			\includegraphics[width=0.5\textwidth]{images/Samplefigure3.eps}
			\label{fig:AntipatternStats_6}
		}
	\end{figure}
