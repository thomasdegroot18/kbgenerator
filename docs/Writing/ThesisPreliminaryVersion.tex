...
% TODO: Solved paper issue with searching for sampling instead of generating
...
The algorithm that is used in matching is explained here is an adaptation of the VF2 algorithm\cite{LCordella2004} is implemented with: solving the problem. %TODO
...
\begin{enumerate}
	...
	\item Generalize on basis of isomorphic, check if vertex isomorphic and edge isomorphic %DONE
	\item Add in ... steps to further generalize. %TODO
	\item Count the amount of occurrences per "generalized" inconsistent subgraph %DONE
