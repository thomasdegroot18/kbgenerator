...
\begin{figure}[ht]
	...
	\subfloat[Example contradiction 1.\label{fig:Example1}]{%
		\includegraphics[width=0.33\textwidth]{images/Example1.png}
	}
	\subfloat[Example contradiction 2.\label{fig:Example2}]{%
		\includegraphics[width=0.33\textwidth]{images/Example2.png}
	}
	\subfloat[Example contradiction 3.\label{fig:Example3}]{%
		\includegraphics[width=0.33\textwidth]{images/Example3.png}
	}
