...
\begin{itemize}
	# Vijlen
	\item \textbf{RQ1}: Can we describe and define a formal definition for general contradiction patterns, which <>stand for inconsistent subgraphs independent throughout all knowledge graphs?
...
- Inconsistency:
Rewrite with entailment en expressive knowlegde graphs. Toevoeging sematisch vocab
...
\newpage
\chapter{Problem Definition}\label{ProblemDefintion}
...
\newpage
\chapter{Applications}\label{Implementation}
...
\section{Experiment 3: \textbf{RQ3}: Implementation 1, Analysing inconsistent graphs}
...
\section{Experiment 4: \textbf{RQ3}: Use case 2, Sampling inconsistent graphs} 
