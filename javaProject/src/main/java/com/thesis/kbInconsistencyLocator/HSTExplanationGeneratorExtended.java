...
public class HSTExplanationGeneratorExtended implements MultipleExplanationGenerator {

        private static final Logger LOGGER = LoggerFactory.getLogger(com.clarkparsia.owlapi.explanation.HSTExplanationGenerator.class);
         ...
         */
        public HSTExplanationGeneratorExtended(TransactionAwareSingleExpGen singleExplanationGenerator) {
        ...
        public Set<Set<OWLAxiom>> getExplanations(OWLClassExpression unsatClass) {
            return getExplanations(unsatClass, 0, System.currentTimeMillis()+ 60000);
        }
            ...
            try {
                ...
                try {
                    constructHittingSetTree(unsatClass, firstMups, allMups, satPaths,
                            currentPathContents, maxExplanations, timeOut);
                } finally {
        ...
        private void constructHittingSetTree(OWLClassExpression unsatClass, Set<OWLAxiom> mups,
                                             ...
                                             Set<Set<OWLAxiom>> satPaths, Set<OWLAxiom> currentPathContents, int maxExplanations, long timeOut)
                throws OWLException {
        ...
        private List<OWLAxiom> recurse(OWLClassExpression unsatClass, Set<Set<OWLAxiom>> allMups,
                                       ...
                                       OWLAxiom axiom, long  timeOut) throws OWLException {
